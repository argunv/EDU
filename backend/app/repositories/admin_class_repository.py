"""Единственный выделенный repository в MVP: список/CRUD классов для админки.

Остальная персистенция остаётся в роутерах намеренно; расширять слой репозиториев
в рамках заморозки MVP не планируется."""
